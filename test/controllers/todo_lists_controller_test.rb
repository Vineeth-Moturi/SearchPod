...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { date: @todo_list.date, item: @todo_list.item, status: @todo_list.status, user_id: @todo_list.user_id, userid: @todo_list.userid } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { date: @todo_list.date, item: @todo_list.item, status: @todo_list.status, user_id: @todo_list.user_id, userid: @todo_list.userid } }
